    ...
    <>
      <div className=''>
        ...
        <div className='relative z-'>
          <header className='flex flex-col justify-center items-center w-full h-screen  text-white'>
          ...
          <section className='flex flex-col justify-center items-center w-full mb-10'>
            <h1 className='text-blue-950 text-4xl p-10'>Projects</h1>
            <div className='w-[80%] flex flex-row justify-around '>
              <div className='w-100 h-120  rounded-3xl flex flex-col justify-between items-center hover:cursor-pointer hover:scale-110 transform ease-in-out transition-all shadow-2xl'>
          ...
          <section className='w-full h-screen bg-[#132440] text-white flex flex-col justify-around  p-6'>
            <h1 className='text-4xl'>About Me</h1>
            <div className='text-3xl'>
              <h1>
                Who Am I?
              </h1>
              <h2 className='text-xl leading-relaxed p-1'>
          ...
          <footer className='p-5 flex flex-col'>
            <h1 className=' flex flex-row justify-center p-5 text-3xl'>Contact me</h1>
            <div className='border-b border-[#132440] flex flex-row justify-around p-4 m-1'>{/*  improve the ui when you copy eihter the phone number or email */}
              <p className='text-2xl flex flex-col justify-center items-center' onClick={() => { navigator.clipboard.writeText("7272779828"); alert("Phone number copied!") }}>
                <svg width="70" height="70" className="hover:cursor-pointer ">
                  <use href={`${sprite}#phone`} />
                </svg>
                727-277-9828
              </p>
              <p className='text-2xl flex flex-col justify-center items-center' onClick={() => navigator.clipboard.writeText("Jahirherrera12345@gmail.com")}>
                <svg width="70" height="70" className="hover:cursor-pointer ">
                  <use href={`${sprite}#gmail`} />
                </svg>
                Jahirherrera12345@gmail.com
              </p>
